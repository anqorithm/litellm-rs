...
"#;
        ...
        let config: BudgetConfiguration = serde_norway::from_str(yaml).unwrap();
...
"#;
        ...
        let config: ProviderBudgetConfig = serde_norway::from_str(yaml).unwrap();
...
"#;
        ...
        let config: ModelBudgetConfig = serde_norway::from_str(yaml).unwrap();
    ...
    fn test_reset_period_config() {
        assert_eq!(
            serde_norway::from_str::<ResetPeriodConfig>("daily").unwrap(),
            ResetPeriodConfig::Daily
        );
        assert_eq!(
            serde_norway::from_str::<ResetPeriodConfig>("weekly").unwrap(),
            ResetPeriodConfig::Weekly
        );
        assert_eq!(
            serde_norway::from_str::<ResetPeriodConfig>("monthly").unwrap(),
            ResetPeriodConfig::Monthly
        );
        assert_eq!(
            serde_norway::from_str::<ResetPeriodConfig>("never").unwrap(),
