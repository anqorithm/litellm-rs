...
pub(crate) fn to_domain_api_key(managed: &ManagedApiKey) -> Result<ApiKey> {
    ...
    Ok(ApiKey {
        ...
        usage_stats: UsageStats {
            ...
            unpriced_requests: managed.usage_stats.unpriced_requests,
            unpriced_tokens: managed.usage_stats.unpriced_tokens,
            unpriced_cost: managed.usage_stats.unpriced_cost,
            last_unpriced_at: managed.usage_stats.last_unpriced_at,
...
pub(crate) fn from_domain_api_key(api_key: &ApiKey) -> ManagedApiKey {
    ...
    ManagedApiKey {
        ...
        usage_stats: KeyUsageStats {
            ...
            unpriced_requests: api_key.usage_stats.unpriced_requests,
            unpriced_tokens: api_key.usage_stats.unpriced_tokens,
            unpriced_cost: api_key.usage_stats.unpriced_cost,
            last_unpriced_at: api_key.usage_stats.last_unpriced_at,
