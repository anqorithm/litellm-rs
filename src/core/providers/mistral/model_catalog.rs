...
const MODEL_SPECS: &[MistralModelSpec] = &[
    ...
    MistralModelSpec {
        id: "mistral-small-4",
        name: "Mistral Small 4 (alias -> mistral-small-2603)",
        max_context_length: 256000,
        supports_streaming: true,
        supports_tools: true,
        supports_multimodal: true,
        input_cost_per_1k_tokens: 0.00015,
        output_cost_per_1k_tokens: 0.0006,
        alias_for: Some("mistral-small-2603"),
    },
    MistralModelSpec {
    ...
    MistralModelSpec {
        ...
        input_cost_per_1k_tokens: 0.002,
        output_cost_per_1k_tokens: 0.005,
        alias_for: Some("magistral-medium-2509"),
    },
    MistralModelSpec {
    ...
    MistralModelSpec {
        ...
        input_cost_per_1k_tokens: 0.0005,
        output_cost_per_1k_tokens: 0.0015,
        alias_for: Some("magistral-small-2509"),
    },
    MistralModelSpec {
    ...
    MistralModelSpec {
        ...
        input_cost_per_1k_tokens: 0.00004,
        output_cost_per_1k_tokens: 0.00004,
        alias_for: None,
    },
    MistralModelSpec {
    ...
    MistralModelSpec {
        id: "devstral-2-2512",
        name: "Devstral 2 2512 (alias -> devstral-2512)",
        max_context_length: 262144,
        supports_streaming: true,
        supports_tools: true,
        supports_multimodal: false,
    ...
    MistralModelSpec {
        id: "mistral-large",
        name: "Mistral Large (alias -> mistral-large-2512)",
        max_context_length: 262144,
        supports_streaming: true,
        supports_tools: true,
        supports_multimodal: true,
        input_cost_per_1k_tokens: 0.0005,
        output_cost_per_1k_tokens: 0.0015,
        alias_for: Some("mistral-large-2512"),
    },
    MistralModelSpec {
        id: "mistral-small",
        name: "Mistral Small (alias -> mistral-small-2603)",
        max_context_length: 256000,
        supports_streaming: true,
        supports_tools: true,
        supports_multimodal: true,
    ...
    MistralModelSpec {
        id: "mistral-medium",
        name: "Mistral Medium (alias -> mistral-medium-3-5)",
        max_context_length: 256000,
        supports_streaming: true,
        supports_tools: true,
        supports_multimodal: true,
        input_cost_per_1k_tokens: 0.0015,
        output_cost_per_1k_tokens: 0.0075,
        alias_for: Some("mistral-medium-3-5"),
    },
    MistralModelSpec {
        id: "mistral-embed",
        name: "Mistral Embed",
