...
`codestral`, `custom_api`, `datarobot`, `deepgram`, `deepl`, `elevenlabs`, `huggingface`, `jina`, `langgraph`, `milvus`, `oci`, `ollama`, `pg_vector`, `recraft`, `runwayml`, `sagemaker`, `searxng`, `snowflake`, `spark`, `stability`, `tavily`, `voyage`, `watsonx`
