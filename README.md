...
`codestral`, `custom_api`, `datarobot`, `deepgram`, `deepl`, `elevenlabs`, `google_pse`, `gradient_ai`, `huggingface`, `jina`, `langgraph`, `milvus`, `nlp_cloud`, `oci`, `ollama`, `pg_vector`, `predibase`, `recraft`, `runwayml`, `sagemaker`, `searxng`, `snowflake`, `spark`, `stability`, `tavily`, `triton`, `voyage`, `watsonx`
